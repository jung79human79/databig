...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		Student stu2 = new Student("ㅁㅁ","ㅊㅊ",55);
		...
		Student stu3 = new Student("ㅁㅁ","ㅊㅊ",55);  // ()안에는 클래스의 속성의 값을 줄 수 있다. 호출하는 것이 아니다.
		System.out.println(stu3.getName());            // 한번 생성자를 만들면 계속 사용가능
