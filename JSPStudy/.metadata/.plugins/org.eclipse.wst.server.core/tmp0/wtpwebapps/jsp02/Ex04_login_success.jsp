...
<body align="center">
	<fieldset>
		...
		<!-- 로그인.html에서 설정한 action값은 로그인jsp에만 태그의 속성을 전달한다  -->
	...
	<!-- Ex04Login.jsp에서 sendRedirect()으로 전송시 url-->
	<!--  http://localhost:8080/jsp02/Ex04_login_success.jsp?data=wjdeown -->
	<!-- Ex04Login.jsp에서 getRequestDispatcher()으로 전송시 url -->
	<!--  http://localhost:8080/jsp02/Ex04Login.jsp -->
