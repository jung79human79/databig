...
public class Ex09ChangeBg extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("컬러는 :"+result);  // 변수명을 문자열과 연결할 시 + 기호사용  //콘솔에 색깔명이 아닌 헥사코드로 표현된다 // '컬러는 :#f31212'
		System.out.println("컬러는 :"+result1);
		...
		// 정재은의 크기에 맟추어 색을 입히자
		out.print("#aa{background-color: "+result+"; color:white; font-size:20px; display: inline;}"); 
