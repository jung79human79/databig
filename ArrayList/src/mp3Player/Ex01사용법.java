...
public class Ex01사용법 {
	...
	public static void main(String[] args) {
		...
		// 1.재생하기
		mp3.play("C:\\Users\\wjd1e\\OneDrive\\바탕 화면\\javaStudy\\ArrayList\\player\\HypeBoy.mp3"); // 스트링 타입의 패쓰= 경로 찾기
        mp3.stop();
        
		// System.out.println(mp3); //이거 아니고 ctrl+f11로 바로 재생
		mp3.play("C:\\Users\\wjd1e\\OneDrive\\바탕// 화면\\javaStudy\\ArrayList\\player\\IAM.mp3"); // 2개가 같이 재생
